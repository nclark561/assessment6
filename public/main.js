...
const drawFive = () => {
    axios.get('http://54.193.249.43/api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://54.193.249.43/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://54.193.249.43/api/player')
...
const getAllBots = () => {
    axios.get('http://54.193.249.43/api/robots')
        .then(({data}) => {
